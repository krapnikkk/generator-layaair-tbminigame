...
declare namespace TBMiniProgram {
  ...
  export interface my {
     ...
     */
    saveFile(options: ISaveFileOptions): void

    /**
     * 获取本地已保存的文件列表
     */
    getSavedFileList(options: IGetSavedFileListOptions): void

    /**
     * 获取本地文件的文件信息
     */
    getSavedFileInfo(options: IGetSavedFileInfoOptions): void

    /**
     * 删除本地存储的文件
     */
    removeSavedFile(options: IRemoveSavedFileOptions): void

    getFileInfo(options: IGetFileInfoOptions): void
  }
}
