...
declare namespace TBMiniProgram {
  ...
  export interface my {
     ...
     */
    startBeaconDiscovery(options: IStartBeaconDiscoveryOptions): void

    /**
     * 停止搜索附近的 iBeacon 设备
     */
    stopBeaconDiscovery(options: IStopBeaconDiscoveryOptions): void
     ...
     */
    getBeacons(options: IGetBeaconsOptions): void

    /**
     * 监听 iBeacon 设备的更新事件
     */
    onBeaconUpdate(options: IOnBeaconUpdateOptions): void
     ...
     */
    onBeaconServiceChange(options: IOnBeaconServiceChangeOptions): void
  }
}
