...
declare namespace TBMiniProgram {
  ...
  interface IOpenBluetoothAdapterOptions {
     ...
     */
    complete?(
      res: IOpenBluetoothAdapterSuccessResult | IOpenBluetoothAdapterFailResult
    ): void
  }
  ...
  export interface my {
     ...
     */
    openBluetoothAdapter(options?: IOpenBluetoothAdapterOptions): void
     ...
     */
    closeBluetoothAdapter(options?: ICloseBluetoothAdapterOptions): void

    /**
     * 获取本机蓝牙模块状态。
     */
    getBluetoothAdapterState(options: IGetBluetoothAdapterStateOptions): void
    ...
    startBluetoothDevicesDiscovery(
      options?: IStartBluetoothDevicesDiscoveryOptions
    ): void
    ...
    stopBluetoothDevicesDiscovery(
      options?: IStopBluetoothDevicesDiscoveryOptions
    ): void
     ...
     */
    getBluetoothDevices(options: IGetBluetoothDevicesOptions): void
    ...
    getConnectedBluetoothDevices(
      options: IGetConnectedBluetoothDevicesOptions
    ): void
     ...
     */
    connectBLEDevice(options: IConnectBLEDeviceOptions): void
     ...
     */
    disconnectBLEDevice(options: IDisconnectBLEDeviceOptions): void
    ...
    writeBLECharacteristicValue(
      options: IWriteBLECharacteristicValueOptions
    ): void
    ...
    readBLECharacteristicValue(
      options: IReadBLECharacteristicValueOptions
    ): void
     ...
     */
    getBLEDeviceServices(options: IGetBLEDeviceServicesOptions): void
    ...
    getBLEDeviceCharacteristics(
      options: IGetBLEDeviceCharacteristicsOptions
    ): void
    ...
    onBluetoothDeviceFound(
      callback: (res: IOnBluetoothDeviceFoundEvent) => void
    ): void
