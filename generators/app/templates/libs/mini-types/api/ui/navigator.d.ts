declare namespace TBMiniProgram {
  ...
  export interface my {
     ...
     */
    navigateTo(options: INavigateToOptions): void

    /**
     * 关闭当前页面，跳转到应用内的某个指定页面。
     */
    redirectTo(options: IRedirectToOptions): void

    /**
     * 关闭当前页面，返回上一级或多级页面。可通过 getCurrentPages 获取当前的页面栈信息，决定需要返回几层。
     */
    navigateBack(options?: INavigateBackOptions): void
     ...
     * 设置导航栏文字及样式。
     */
    setNavigationBar(options: ISetNavigationBarOptions): void
