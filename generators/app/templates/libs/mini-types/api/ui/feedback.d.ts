...
declare namespace TBMiniProgram {
  ...
  export interface my {
     ...
     * 隐藏消息提示框
     */
    hideToast(options?: IHideToastOptions): void
    ...
    prompt(options: IPromptOptions): void
     ...
     * 显示消息提示框
     */
    showLoading(options?: string | IShowLoadingOptions): Promise<void>

    /**
     * 显示消息提示框
     */
    hideLoading(options?: IHideLoadingOptions): Promise<void>

    /**
     * 显示操作菜单。
     */
    showActionSheet(options: IShowActionSheetOptions): void
  }
}
