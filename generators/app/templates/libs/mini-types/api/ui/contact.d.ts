...
declare namespace TBMiniProgram {
  ...
  interface IChooseAlipayContactOptions {
    ...
    complete?(
      result: IChooseAlipayContactSuccessResult | IChooseAlipayContactFailResult
    ): void
  }
  ...
  export interface my {
     ...
     * 选择本地系统通信录中某个联系人的电话。
     */
    choosePhoneContact(options: IChoosePhoneContactOptions): void

    chooseAlipayContact(options: IChooseAlipayContactOptions): void

    /**
     * 唤起选人组件，默认只包含支付宝联系人，可以通过修改参数包含手机通讯录联系人或者双向通讯录联系人。
     */
    chooseContact(options: IChooseContactOptions): void
  }
}
