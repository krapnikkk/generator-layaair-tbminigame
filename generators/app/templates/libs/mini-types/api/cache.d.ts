...
declare namespace TBMiniProgram {
  ...
  export interface my {
     ...
     */
    setStorageSync(options: ISetStorageSyncOptions): void
     ...
     */
    getStorage(option: IGetStorageOptions): void

    /**
     * 同步获取缓存数据。
     */
    getStorageSync(options: IGetStorageSyncOptions): IGetStorageSuccessResult
     ...
     * 同步删除缓存数据。
     */
    removeStorageSync(options: IRemoveStorageSyncOptions): void
     ...
     */
    getStorageInfo(options: IGetStorageInfoOptions): void
