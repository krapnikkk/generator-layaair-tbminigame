...
declare namespace TBMiniProgram {
  ...
  export interface my {
     ...
     * 打开当前用户的某个商户的卡列表
     */
    openMerchantCardList(params: IOpenMerchantCardListOptions): void

    /**
     * 打开当前用户的某张卡的详情页
     */
    openCardDetail(params: IOpenCardDetailOptions): void

    /**
     * 打开支付宝券列表
     */
    openVoucherList(): void

    /**
     * 打开当前用户的某个商户的券列表
     */
    openMerchantVoucherList(params: IOpenMerchantVoucherListOptions): void

    /**
     * 打开当前用户的某张券的详情页（非口碑）
     */
    openVoucherDetail(params: OpenDetailOptions): void

    /**
     * 打开当前用户的某张券的详情页（口碑）
     */
    openKBVoucherDetail(params: OpenDetailOptions): void
     ...
     * 打开某个商户的票列表
     */
    openMerchantTicketList(params: { partnerId: string }): void

    /**
     * 打开当前用户的某张票的详情页
     */
    openTicketDetail(params: OpenDetailOptions): void

    /**
     * 小程序唤起会员开卡授权页面
     */
    addCardAuth(options: IAddCardAuthOptions): void
  }
}
