...
declare namespace TBMiniProgram {
  ...
  export interface my {
     ...
     * 获取视频上下文
     */
    createVideoContext(id: string): IVideoContext

    /**
     * 从本地相册选择图片或使用相机拍照。
     */
    chooseImage(options: IChooseImageOptions): void
     ...
     * 获取图片信息
     */
    getImageInfo(options: IGetImageInfoOptions): void

    /**
     * 保存在线图片到手机相册。
     */
    saveImage(options: ISaveImageOptions): void

    /**
     * 压缩图片。
     */
    compressImage(options: ICompressImageOptions): void
