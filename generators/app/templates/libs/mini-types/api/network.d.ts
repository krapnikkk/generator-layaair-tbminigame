...
declare namespace TBMiniProgram {
  ...
  export interface my {
     ...
     * 小程序网络请求
     */
    request(options: IHttpRequestOptions): IRequestTask
     ...
     */
    uploadFile(options: IUploadFileOptions): void

    /**
     * 下载文件资源到本地。
     * 客户端直接发起一个 HTTP GET 请求，返回文件的本地临时路径。
     */
    downloadFile(options: IDownloadFileOptions): void
     ...
     */
    connectSocket(options: IConnectSocketOptions): void
     ...
     */
    sendSocketMessage(options: ISendSocketMessageOptions): void

    /**
     * 监听WebSocket接受到服务器的消息事件。
     */
    onSocketMessage(callback: (res?: ISocketMessageResponse) => void): void

    /**
     * 关闭WebSocket连接。
     */
    closeSocket(options: ICloseSocketOptions): void
