...
const workSpaceDir = useOtherNode() ? process.argv[2].replace("--gulpfile=", "").replace("\\build\\publish.js", "").replace("/build/publish.js", "") + "/" : "./../";
...
gulp.task("loadConfig", function (cb) {
	...
	if (useOtherNode()) {
		...
		// workSpaceDir = workSpaceDir.replace("build/publish.js/","");
